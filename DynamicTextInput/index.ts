...
context.updatedProperties.indexOf("TextValue") > -1) { 
 ...
 this.autoSizeTextArea();
    ...
    updateStyle(disabled: boolean): void { 
        const newStyle = { 
         ...
         fontSize: this.context.parameters.FontSize.raw ? 
        this.context.parameters.FontSize.raw + "px" : "13px"
        };
        const fontChanged = (this.textarea.style.fontFamily !==
        newStyle.fontFamily) 
